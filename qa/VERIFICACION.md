...
- Publicación confirmada: commit `76de555`, GitHub Actions `35144963000`, instalación limpia, 63 pruebas, compilación y despliegue correctos en 31 s. `lite.html`, `lite.css` y `lite.js` responden HTTP 200; JavaScript publicado: **19.995 bytes**. En https://mauriciostanley.github.io/pulse-road/lite.html se actualizó la caché anterior mediante el aviso normal, se cargó Pequeña Órbita y se registraron seis aciertos consecutivos, 480 puntos, energía 100 y pausa a 9,11 s, sin errores de consola. No es una partida completa pública de esta variante.
- También se verificó que volver a la URL raíz recuerda el modo ligero, y que el botón «Nueva versión: actualizar» del propio ligero aplica una actualización y desaparece tras recargar. ZIPs regenerados y contenido validado, incluidos el reproductor ligero, sus pruebas y los cuatro MP3.
