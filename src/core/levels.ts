...
export const levels: readonly Level[] = [
  { id: "titi", name: "Titi", subtitle: "Fácil", track: "Pequeña Órbita", audio: "tiny-orbit.mp3", bpm: 96, duration: 80, travel: 2.4, lateWindow: 0.20, damage: 14, recovery: 3, description: "Pasos amplios, melodía tranquila. Tu primer camino." },
